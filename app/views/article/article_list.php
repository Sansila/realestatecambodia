...
<?php
 ...
 <div id="breadcrumb">
      ...
      <a href="<?php echo base_url('article/index?m=MTE=&p=NjU=')?>" class="current">Article list</a>
 </div>
<div class="wrapper">
...
<script type="text/javascript">
		...
		function getdata(page){
          	var url="<?php echo site_url('article/getdata')?>";
          	var m="<?PHP echo $m?>";
          	var p="<?PHP echo $p?>";
		...
		function update(event){
				...
				location.href="<?PHP echo site_url('article/edit');?>/"+storeid+"?<?php echo "m=$m&p=$p" ?>";

	...
	<div id="page">
		...
		<div role="main" class="main">
			...
			<!-- Begin Featured -->
			<!-- <section class="pgl-featured pgl-bg-grey hide">
				<div class="container">
					<div class="row">
								...
								<div class="col-xs-4 animation">
									<div class="pgl-property">
										<div class="property-thumb-info">
											...
											<div class="property-thumb-info-content">
												<h3><a href="<?php echo site_url('site/site/detail/'.$list->pid)?>"><?php echo $list->property_name?></a></h3>
												<address><?php echo $list->address?></address>
											</div>

	                                        ...
	                                        <div class="tabs-panel is-active location-panel" id="desktop-location-panel">
	                                        	<div class="location-content">
												    <ul>
												        <li>
												            <label>
												                <input type="checkbox" name="location" value="location:Siem Reap" data-checkbox-changer="" data-target-field="#id_location_autocomplete" data-target-value="location:Siem Reap">Siem Reap</label>
												            <ul></ul>
												        </li>
												        <li>
												            <label>
												                <input type="checkbox" name="location" value="location:Sihanoukville" data-checkbox-changer="" data-target-field="#id_location_autocomplete" data-target-value="location:Sihanoukville">Sihanoukville</label>
												            <ul></ul>
												        </li>
												        <li>
												            <label>
												                <input type="checkbox" name="location" value="location:Kep" data-checkbox-changer="" data-target-field="#id_location_autocomplete" data-target-value="location:Kep">Kep</label>
												            <ul></ul>
												        </li>
												        <li>
												            <label>
												                <input type="checkbox" name="location" value="location:Kampot" data-checkbox-changer="" data-target-field="#id_location_autocomplete" data-target-value="location:Kampot">Kampot</label>
												            <ul></ul>
												        </li>
												        <li>
												            <label>
												                <input type="checkbox" name="location" value="location:Battambang" data-checkbox-changer="" data-target-field="#id_location_autocomplete" data-target-value="location:Battambang">Battambang</label>
												            <ul></ul>
												        </li>
												        <li>
												            <label>
												                <input type="checkbox" name="location" value="location:Phnom Penh" data-checkbox-changer="" data-target-field="#id_location_autocomplete" data-target-value="location:Phnom Penh">Phnom Penh</label>
												            <ul>
												                <li>
												                    <label>
												                        <input type="checkbox" name="location" value="location:Chamkarmon" data-checkbox-changer="" data-target-field="#id_location_autocomplete" data-target-value="location:Phnom Penh > Chamkarmon">Chamkarmon</label>
												                    <ul>
												                        <li>
												                            <label>
												                                <input type="checkbox" name="location" value="location:BKK 1" data-checkbox-changer="" data-target-field="#id_location_autocomplete" data-target-value="location:Phnom Penh > Chamkarmon > BKK 1">BKK 1</label>
												                        </li>
												                        <li>
												                            <label>
												                                <input type="checkbox" name="location" value="location:BKK 2" data-checkbox-changer="" data-target-field="#id_location_autocomplete" data-target-value="location:Phnom Penh > Chamkarmon > BKK 2">BKK 2</label>
												                        </li>
												                        <li>
												                            <label>
												                                <input type="checkbox" name="location" value="location:BKK 3" data-checkbox-changer="" data-target-field="#id_location_autocomplete" data-target-value="location:Phnom Penh > Chamkarmon > BKK 3">BKK 3</label>
												                        </li>
												                        <li>
												                            <label>
												                                <input type="checkbox" name="location" value="location:Tonle Bassac" data-checkbox-changer="" data-target-field="#id_location_autocomplete" data-target-value="location:Phnom Penh > Chamkarmon > Tonle Bassac">Tonle Bassac</label>
												                        </li>
												                        <li>
												                            <label>
												                                <input type="checkbox" name="location" value="location:Toul Tum Poung 1" data-checkbox-changer="" data-target-field="#id_location_autocomplete" data-target-value="location:Phnom Penh > Chamkarmon > Toul Tum Poung 1">Toul Tum Poung 1</label>
												                        </li>
												                    </ul>
												                </li>
												                <li>
												                    <label>
												                        <input type="checkbox" name="location" value="location:Daun Penh" data-checkbox-changer="" data-target-field="#id_location_autocomplete" data-target-value="location:Phnom Penh > Daun Penh">Daun Penh</label>
												                    <ul>
												                        <li>
												                            <label>
												                                <input type="checkbox" name="location" value="location:Chakto Mukh" data-checkbox-changer="" data-target-field="#id_location_autocomplete" data-target-value="location:Phnom Penh > Daun Penh > Chakto Mukh">Chakto Mukh</label>
												                        </li>
												                        <li>
												                            <label>
												                                <input type="checkbox" name="location" value="location:Phsar Chas" data-checkbox-changer="" data-target-field="#id_location_autocomplete" data-target-value="location:Phnom Penh > Daun Penh > Phsar Chas">Phsar Chas</label>
												                        </li>
												                        <li>
												                            <label>
												                                <input type="checkbox" name="location" value="location:Phsar Kandal I" data-checkbox-changer="" data-target-field="#id_location_autocomplete" data-target-value="location:Phnom Penh > Daun Penh > Phsar Kandal I">Phsar Kandal I</label>
												                        </li>
												                        <li>
												                            <label>
												                                <input type="checkbox" name="location" value="location:Phsar Thmei I" data-checkbox-changer="" data-target-field="#id_location_autocomplete" data-target-value="location:Phnom Penh > Daun Penh > Phsar Thmei I">Phsar Thmei I</label>
												                        </li>
												                        <li>
												                            <label>
												                                <input type="checkbox" name="location" value="location:Wat Phnom" data-checkbox-changer="" data-target-field="#id_location_autocomplete" data-target-value="location:Phnom Penh > Daun Penh > Wat Phnom">Wat Phnom</label>
												                        </li>
												                    </ul>
												                </li>
												                <li>
												                    <label>
												                        <input type="checkbox" name="location" value="location:7 Makara" data-checkbox-changer="" data-target-field="#id_location_autocomplete" data-target-value="location:Phnom Penh > 7 Makara">7 Makara</label>
												                    <ul></ul>
												                </li>
												                <li>
												                    <label>
												                        <input type="checkbox" name="location" value="location:Toul Kork" data-checkbox-changer="" data-target-field="#id_location_autocomplete" data-target-value="location:Phnom Penh > Toul Kork">Toul Kork</label>
												                    <ul></ul>
												                </li>
												                <li>
												                    <label>
												                        <input type="checkbox" name="location" value="location:Chroy Changvar" data-checkbox-changer="" data-target-field="#id_location_autocomplete" data-target-value="location:Phnom Penh > Chroy Changvar">Chroy Changvar</label>
												                    <ul></ul>
												                </li>
												                <li>
												                    <label>
												                        <input type="checkbox" name="location" value="location:Sen Sok" data-checkbox-changer="" data-target-field="#id_location_autocomplete" data-target-value="location:Phnom Penh > Sen Sok">Sen Sok</label>
												                    <ul></ul>
												                </li>
												                <li>
												                    <label>
												                        <input type="checkbox" name="location" value="location:Russey Keo" data-checkbox-changer="" data-target-field="#id_location_autocomplete" data-target-value="location:Phnom Penh > Russey Keo">Russey Keo</label>
												                    <ul></ul>
												                </li>
												                <li>
												                    <label>
												                        <input type="checkbox" name="location" value="location:Meanchey" data-checkbox-changer="" data-target-field="#id_location_autocomplete" data-target-value="location:Phnom Penh > Meanchey">Meanchey</label>
												                    <ul></ul>
												                </li>
												                <li>
												                    <label>
												                        <input type="checkbox" name="location" value="location:Dangkao" data-checkbox-changer="" data-target-field="#id_location_autocomplete" data-target-value="location:Phnom Penh > Dangkao">Dangkao</label>
												                    <ul></ul>
												                </li>
												                <li>
												                    <label>
												                        <input type="checkbox" name="location" value="location:Chbar Ampov" data-checkbox-changer="" data-target-field="#id_location_autocomplete" data-target-value="location:Phnom Penh > Chbar Ampov">Chbar Ampov</label>
												                    <ul></ul>
												                </li>
												                <li>
												                    <label>
												                        <input type="checkbox" name="location" value="location:Prek Pnov" data-checkbox-changer="" data-target-field="#id_location_autocomplete" data-target-value="location:Phnom Penh > Prek Pnov">Prek Pnov</label>
												                    <ul></ul>
												                </li>
												                <li>
												                    <label>
												                        <input type="checkbox" name="location" value="location:Por Sen Chey" data-checkbox-changer="" data-target-field="#id_location_autocomplete" data-target-value="location:Phnom Penh > Por Sen Chey">Por Sen Chey</label>
												                    <ul></ul>
												                </li>
												            </ul>
												        </li>
												        <li>
												            <label>
												                <input type="checkbox" name="location" value="location:Kandal" data-checkbox-changer="" data-target-field="#id_location_autocomplete" data-target-value="location:Kandal">Kandal</label>
												            <ul></ul>
												        </li>
												    </ul>
												</div>

...
<script type="text/javascript">
		...
		function getdata(page){
          	var url="<?php echo site_url('property/propertytype/getdata')?>";
          	var m="<?PHP echo $m?>";
          	var p="<?PHP echo $p?>";
		...
		function update(event){
				...
				location.href="<?PHP echo site_url('property/propertytype/edit');?>/"+storeid+"?<?php echo "m=$m&p=$p" ?>";
		...
		function deletestore(event){
			var conf=confirm("Are you sure to delete this Type");
			if(conf==true){
				var storeid=jQuery(event.target).attr("rel");
				var url="<?php echo site_url('property/propertytype/delete')?>/"+storeid;
				$.ajax({
		            url:url,
		            type:"POST",
		            datatype:"Json",

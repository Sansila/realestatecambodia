							...
							<div style="text-align: right; width:130px; float:right">
						    	...
						    	<span class="top_action_button">
						    		<?php if($this->green->gAction("C")){ ?>
							    		<a href="<?php echo site_url("product/add?m=$m&p=$p")?>" >
...
<script type="text/javascript">
		...
		function getdata(page){
          	var url="<?php echo site_url('product/getdata')?>";
          	var m="<?PHP echo $m?>";
          	var p="<?PHP echo $p?>";
		...
		function update(event){
				...
				window.open("<?PHP echo site_url('product/edit');?>/"+storeid+"?<?php echo "m=$m&p=$p" ?>",'_blank');

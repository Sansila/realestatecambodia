							...
							foreach ($query as $row) {
								echo "
								   ...
								   echo "<td align='center'>";
								   		if($row->roleid!=1){
								   			echo "<a><img rel='$row->roleid' onclick='deleterole(event);'  src='".base_url('assets/images/icons/delete.png')."'/></a> ";
								   		}
								   	echo "<a ><img  rel='$row->roleid' onclick='updaterole(event);' src='".base_url('assets/images/icons/edit.png')."'/></a></td>
									</tr>
